...
- Always show price information when listing services and products, but never push the customer to choose based on price. Do not need to show descriptions unless the customer asks for more details.
