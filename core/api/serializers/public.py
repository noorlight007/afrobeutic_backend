...
from apps.salon.choices import BookingStatus, CustomerType, SalonStatus, BookingSource
...
class PublicSalonBookingSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["booking_id", "status", "booking_duration", "source"]
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            validated_data["source"] = BookingSource.AFROBEUTIC
