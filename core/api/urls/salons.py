...
from ..views.salons import (
    ...
    SalonWhatsappChatbotConfigView,
    SalonWhatsappView,
...
urlpatterns = [
    ...
    path(
        "/<uuid:salon_uid>/whatsapp-config",
        SalonWhatsappChatbotConfigView.as_view(),
        name="salon.whatsapp-config",
    ),
    path(
    ...
    path(
        "/<uuid:salon_uid>/lookbook/<uuid:lookbook_uid>/images/<uuid:image_uid>",
        SalonLookBookImageDeleteView.as_view(),
        name="salon.lookbook-image-delete",
    ),
    path(
